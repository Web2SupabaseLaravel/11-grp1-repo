...
<main>
    ...
    <input type="text" name="teacher_id" value="{{ $course->teacher_id }}" required>

    <label for="start_time">Start Time</label>
    <input type="datetime-local" name="start_time" value="{{ \Carbon\Carbon::parse($course->start_time)->format('Y-m-d\TH:i') }}" required>

    <label for="end_time">End Time</label>
    <input type="datetime-local" name="end_time" value="{{ \Carbon\Carbon::parse($course->end_time)->format('Y-m-d\TH:i') }}" required>
